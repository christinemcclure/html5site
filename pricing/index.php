...
<section>
	...
	<div class="columnBlock">
      ...
      <p>After the event, you will receive a collection of high-resolution photos (up to 4MB per picture).</p>
	...
	<h2>Portraiture</h2>
    	...
    	<p>Pricing is based on a flat-rate sitting fee for one hour of shooting. Additional time can be purchased for location and wardrobe changes. After the event, you will receive a collection of high-resolution photos (up to 4MB per picture). Prints, merchandise, and photo downloads will also be available online</a> for family and friends to purchase.</p>
	</div>

  <div class="columnBlock">
	<h2>Ordering Prints</h2>
			<p>Prints, merchandise, and photo downloads are <a href="http://christinemcclure.zenfolio.com">available online</a> for family and friends to purchase.</p>
	</div>
