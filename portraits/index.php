...
<section>
	<h1 class="top">Portraiture</h1>
		<ul class="print">
			...
			<li><p>Nadia's first swim</p><img src="/img/portraits/pool.jpg" alt="Photo of a father holding his baby daughter in a swimming pool." /></li>      
